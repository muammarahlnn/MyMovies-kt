...
import com.ardnn.mymovies.databinding.FragmentTopRatedTvShowsBinding
import com.ardnn.mymovies.listeners.SingleClickListener
import com.ardnn.mymovies.models.TvShowOutline

class TopRatedTvShowsFragment : Fragment(), SwipeRefreshLayout.OnRefreshListener,
    SingleClickListener<TvShowOutline> {

    // view binding
    private var _binding: FragmentTopRatedTvShowsBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentTopRatedTvShowsBinding.inflate(inflater, container, false)

        // set swipe refresh layout
        binding.srlTopRatedTvShows.setOnRefreshListener(this)
    ...
    private fun loadData(page: Int) {
        TvShowRepository.getTopRatedTvShows(page, object : TvShowOutlineCallback {
            override fun onSuccess(tvShowOutlineList: MutableList<TvShowOutline>) {
                ...
                isFetching = false
                binding.srlTopRatedTvShows.isRefreshing = false
            }
    ...
    private fun setRecyclerView() {
        ...
        binding.rvTopRatedTvShows.layoutManager = layoutManager

        // set adapter
        adapter = TvShowsPrimaryAdapter(tvShowList, this)
        binding.rvTopRatedTvShows.adapter = adapter

        // listener if recyclerview reached last item then fetch next page
        binding.rvTopRatedTvShows.addOnScrollListener(object : RecyclerView.OnScrollListener() {
